...
func NewDefaultExtractor(client *http.Client, logger interface{}) *DefaultExtractor {
	return &DefaultExtractor{httpClient: client, userAgent: "Mozilla/5.0 (compatible; RSSFullTextBot/1.0)", logger: logger}
}
